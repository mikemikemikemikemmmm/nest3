...
export const ProductListPage = () => {
    ...
    const renderMenuIndexProductCards = () => {
        const allProductDoms = [] as JSX.Element[]
        seriesDatas.map(series => series.productCards.forEach(card =>
            allProductDoms.push(<ProductCardComponent key={card.id} {...card} />)
        ))
        return allProductDoms
    }
    return (
